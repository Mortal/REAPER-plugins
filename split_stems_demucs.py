...
async def split_stems_demucs(*, two_stems: Literal["bass", "drums", "vocals"] | None = None, modelname: Literal["mdx_extra_q", "htdemucs"] = "htdemucs") -> None:
    ...
    if not all(os.path.exists(p) for p in paths):
        proc = await asyncio.subprocess.create_subprocess_exec(
            ...
            "demucs", *two_stems_arg, "-n", modelname, "--float32", "-o", prep.dirname, "--filename", filename_fmt, prep.source_slice.path
        )
